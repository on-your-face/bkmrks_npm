...
async function preloadFonts() {
    await Promise.all([loadFont("OpenSans", { woff: "./assets/fonts/OpenSans-Light.woff", woff2: "./assets/fonts/OpenSans-Light.woff2" }, { style: "normal", weight: "400" }), loadFont("Lora-Regular", { woff: "./assets/fonts/Lora-Regular.woff", woff2: "./assets/fonts/Lora-Regular.woff2" }, { style: "normal", weight: "400" })]);
}
...
function initModal() {
    ...
    document.addEventListener("touchstart", (e) => {
        ...
        document.addEventListener("touchmove", (t) => {
            ...
            n && s && ((r = t.touches[0].clientX), a - r > 150 && (n.classList.remove("open"), e(), o(), (s = !1), delete n.dataset.isSwiping));
        }),
        ...
        e.addEventListener("click", function (e) {
            ...
            if (t) {
                ...
                if (e) {
                    ...
                    (t.style.position = "fixed"), (t.style.opacity = "0"), (t.value = e), document.body.appendChild(t), t.focus(), t.select(), document.execCommand("copy"), document.body.removeChild(t);
                }
            }
        });
    });
